      ...
      with tf.variable_scope(_DECODER_SCOPE, _DECODER_SCOPE, [features]):
        ...
        if feature_list is None:
          ...
          for i, name in enumerate(feature_list):
            ...
            batch_size = tf.cast((s[0] / seq_length), tf.int32)
          ...
          # add convLSTM here
          # [batch * s, h, w, c] -> tf.reshape(decoder_features, [batch, s, h, w, c]) -> convLSTM -> [batch, s, h, w, c]
          # initialize convLSTM weights (search online)
          # try github convGRUs if convLSTMs work
          # returns final state, adjust indexing to return intermediate states: [0][:,-1]
